  ...
  return (
    <section id="about" className="py-20 md:py-28 px-6 md:px-12 bg-slate-50/70 border-y border-slate-100 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          <span className="inline-block border border-slate-200 bg-white rounded-full px-4 py-1 text-[11px] font-semibold text-slate-500 mb-5 tracking-wide shadow-xs">
            About Trek & Stay
          </span>
          <h2 className="text-3xl md:text-4xl lg:text-[44px] font-bold text-slate-900 leading-[1.18] tracking-tight mb-6">
            Where Every Wilderness<br />Journey Begins
          </h2>
          <p className="text-base md:text-lg text-slate-900 font-semibold mb-4 leading-snug">
            Curating high-energy monsoon trails, Sahyadri fort climbs, and sacred Himalayan expeditions from Karnataka.
          </p>
          <p className="text-slate-500 text-xs md:text-sm leading-relaxed mb-8 max-w-lg">
            At Trek & Stay, we believe that real adventure should combine wilderness thrill with complete peace of mind. With departures connecting Bengaluru, Mysuru, Mangaluru, Hubballi, and Pune, our packages include round-trip transportation, cozy shared stays, delicious meals, and certified trek leaders. Whether rappelling 300ft waterfalls or conquering historical pinnacle forts, we guide you into the wild safely.
          </p>
