      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <span className="inline-block border border-emerald-100 rounded-full px-4 py-1 text-[11px] font-bold text-emerald-700 tracking-wide bg-emerald-50">
                Weekly Monsoon & Weekend Departures
              </span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-[44px] font-extrabold leading-[1.15] tracking-tight text-slate-900">
              Curated Western Ghats &<br />Sahyadri Monsoon Expeditions
            </h2>
          </div>
        </div>
        ...
        <div className="relative group/scroll mb-16">
          ...
          >
            {displayedDestinations.map((dest) => (
              <div 
                ...
                className="group relative min-w-[280px] sm:min-w-[320px] md:min-w-0 rounded-[32px] overflow-hidden bg-slate-900 shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col justify-between aspect-[3.6/5.1] cursor-pointer snap-center"
              ...
              <div className="relative z-10 p-5 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="w-9 h-9 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center text-white transition-all duration-300 group-hover:bg-white group-hover:text-slate-900 shadow-md"
              ...
              <div className="relative z-10 p-6 text-white">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-white/15">
                  <div>
                    <span className="text-[10px] text-slate-300 block uppercase tracking-wider">All-Inclusive</span>
                    <div className="flex items-baseline gap-1.5">
                      <span className="text-xl font-extrabold text-white">{dest.price}</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded-full text-xs font-bold transition-all shadow-md active:scale-95 cursor-pointer"
                    >
                      Book
                    </button>
                  </div>
          ...
          <div className="hidden md:flex absolute top-1/2 -translate-y-1/2 left-0 right-0 justify-between px-2 pointer-events-none opacity-0 group-hover/scroll:opacity-100 transition-opacity">
            <button 
              onClick={() => scroll('left')}
              className="w-10 h-10 rounded-full bg-white/90 backdrop-blur-md shadow-lg flex items-center justify-center text-slate-900 pointer-events-auto hover:bg-white transition-all active:scale-95"
            >
