...
export const DocumentBrochureView: React.FC = () => {
  // Theme & UI states
  ...
  return (
    <div className={`min-h-screen transition-colors ${docTheme === 'light' ? 'bg-stone-200/90 text-stone-900' : 'bg-stone-950 text-stone-100'}`}>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-xs font-bold text-white flex items-center gap-1.5 font-serif-brand">
                ...
                <span className="text-amber-400 font-sans font-semibold text-[11px]">Official Itinerary PDF</span>
              </div>
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className={`p-5 rounded-xl border-2 flex flex-col justify-between ${
                ...
                <div className="mt-4 pt-3 border-t border-stone-200 dark:border-stone-700 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => openBookingModalForPackage('bangalore')}
                    className="no-print px-3.5 py-1.5 bg-amber-600 hover:bg-amber-500 text-white rounded-lg text-xs font-bold transition shadow-sm"
                  >
              ...
              <div className={`p-5 rounded-xl border flex flex-col justify-between ${
                ...
                <div className="mt-4 pt-3 border-t border-stone-200 dark:border-stone-700 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="no-print px-3.5 py-1.5 bg-stone-700 hover:bg-stone-600 text-white rounded-lg text-xs font-bold transition"
                  >
                    Reserve Delhi Plan
                  </button>
                </div>
            ...
            <div className={`p-5 rounded-xl border text-center ${
              ...
              <div className="mt-4 flex justify-center gap-3 text-xs flex-wrap">
                ...
                <button
                  onClick={() => openBookingModalForPackage('bangalore')}
                  className="no-print px-3.5 py-1.5 bg-emerald-700 hover:bg-emerald-600 text-white rounded-lg font-bold flex items-center gap-1.5 transition shadow"
                >
            ...
            <div className="bg-stone-950 text-stone-100 p-6 rounded-xl border border-stone-800 text-center print-avoid-break">
              ...
              <div className="mt-6 pt-4 border-t border-stone-800 flex flex-wrap justify-center gap-3 no-print">
                ...
                <button
                  onClick={handlePrint}
                  className="px-4 py-2 bg-stone-800 hover:bg-stone-700 text-stone-200 border border-stone-700 rounded-lg text-xs font-semibold flex items-center gap-1.5 transition"
                >
                  <Printer className="w-3.5 h-3.5" />
                ...
                <>
                  ...
                  <div className="bg-stone-800/80 p-3.5 rounded-xl border border-stone-700 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="w-8 h-8 rounded-lg bg-stone-700 hover:bg-stone-600 text-white font-bold text-base flex items-center justify-center transition"
                      >
                        -
                      </button>
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-lg bg-amber-600 hover:bg-amber-500 text-white font-bold text-base flex items-center justify-center transition"
                      >
                        +
                      </button>
                    </div>
                  ...
                  <div className="bg-white rounded-xl p-4 text-center text-stone-900 shadow-md">
                    ...
                    <div className="mt-2.5 flex items-center justify-between bg-stone-100 p-2 rounded-lg border border-stone-300 text-xs">
                      ...
                      <button
                        type="button"
                        onClick={handleCopyUpi}
                        className="flex items-center gap-1 text-[11px] font-bold text-amber-800 hover:text-amber-900 bg-amber-100 hover:bg-amber-200 px-2 py-1 rounded transition"
                      >
                  ...
                  <form onSubmit={handleConfirmVoucher} className="space-y-3 pt-3 border-t border-stone-800">
                    ...
                    <div className="pt-2 flex gap-3">
                      <button
                        type="submit"
                        className="flex-1 py-2.5 bg-amber-600 hover:bg-amber-500 text-white font-bold rounded-xl shadow transition flex items-center justify-center gap-1.5"
                      >
      ...
      <aside aria-label="Quick Actions" className="fixed bottom-4 right-4 z-40 flex items-center gap-2 no-print">
        ...
        <button
          onClick={() => openBookingModalForPackage('bangalore')}
          className="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full font-bold text-xs shadow-xl flex items-center gap-2 border border-emerald-400/40 transition transform active:scale-95"
